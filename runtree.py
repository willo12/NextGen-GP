...
#  sys.path.remove(dir_path)
  ...
  Iffs,result,obs,I, tree,model,ts_factor,startscore_i, S_init, otime, scores = single_run(tree,config,SPACEDIM)
...
#  plt.plot(otime*1e-3,result[I[startscore_i:],2],'y'); 
  ...
  plt.legend([c1,c2,c3],['obs','$S_1$','$S_2$'])
...
# from old runtree:
#nextgen.nextgen(Iffs,result,old_score_vals,score_vals,obs,I, tree,'yo',0,0,0,popsize,model )
